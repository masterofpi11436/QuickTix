...
class ReportingUserTicketController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('reporting-user.tickets.index', compact('ticketsByType'));
    }
    ...
    {
        return view('reporting-user.tickets.create-ticket');
    }
    ...
    public function show(Ticket $ticket)
    {
        ...
        return view('reporting-user.tickets.show', compact('ticket', 'assignees', 'completedStatuses', 'statusLabels', 'pendingStatus'));
    }
    ...
    public function assign(Request $request, Ticket $ticket)
    {
        ...
        return redirect()
            ->route('reporting-user.tickets.index', $ticket)
    ...
    public function destroy(Ticket $ticket)
    {
        ...
        return redirect()
            ->route('reporting-user.tickets.index')
