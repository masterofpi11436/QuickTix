...
class ControllerTicketController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('controller.tickets.index', compact('ticketsByType'));
    }
    ...
    {
        return view('controller.tickets.create-ticket');
    }
    ...
    public function assign(Request $request, Ticket $ticket)
    {
        ...
        return redirect()
            ->route('controller.tickets.index', $ticket)
    ...
    public function destroy(Ticket $ticket)
    {
        ...
        return redirect()
            ->route('controller.tickets.index')
