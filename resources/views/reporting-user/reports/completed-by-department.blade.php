    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 sm:p-6">
                <form method="GET" action="{{ route('reporting-user.reports.completed-by-department') }}" class="space-y-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('reporting-user.reports.completed-by-department') }}"
