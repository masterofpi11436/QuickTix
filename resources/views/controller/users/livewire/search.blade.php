                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-3">
                    ...
                    <div class="flex flex-col items-end gap-2">
                        ...
                        <div class="flex flex-col sm:flex-row gap-2 sm:items-center">
                            ...
                            <x-custom-button href="{{ route('controller.users.create') }}" color="blue">
                                Create User
                            </x-custom-button>
                        </div>
                    </div>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex flex-wrap gap-2">
                                            <x-custom-button href="{{ route('controller.users.edit', $user) }}" color="yellow">Edit</x-custom-button>

                                            <x-custom-button
                                                href="{{ route('controller.users.destroy', $user) }}"
                                                method="DELETE"
                                                color="red"
                                            >
                                                Delete
